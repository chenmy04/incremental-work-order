...
| `walkthrough.md` | A full worked case: a mid-flight decision, a blocker, a revision, a checkpoint, a defect found by testing, and a merge pinned to a snapshot | read it |
